...
test_that("Test la mise en forme des données climatiques pour la simulation avec EvolClim=0,
          AccModif=ORI et MortModif=ORI", {
            ...
            expect_equal(Data_0_ORI_ORI[[3]], expect_test_for_ClimatTot_0_ORI )
          })
